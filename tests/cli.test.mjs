...
test("CLI exposes help and operates only on explicit generated roots", async () => {
  await withSandbox(async ({ base, root, runId }) => {
    ...
    assert.deepEqual(jsonHelp.result.commands, ["init", "index", "context", "run", "apply", "propose", "decide", "approval-status", "approval-visual", "undo", "doctor", "audit", "migrate-stage", "migrate-finalize", "workspace-upgrade", "help"]);
